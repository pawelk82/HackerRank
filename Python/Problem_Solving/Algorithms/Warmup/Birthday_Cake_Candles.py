...
#Complete the function birthdayCakeCandles that takes your niece's age and an integer array containing height of each candle 
#as input, and return the number of candles she can successfully blow out.
